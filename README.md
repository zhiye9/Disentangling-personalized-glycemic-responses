...
- Progressive multilevel model building (null, nutrients, meal timing, random carbohydrate slopes) with variance component analysis (ICC, Nakagawa R-squared, personalization gap).
- BLUP extraction with per-person reliability estimation and meals-needed projections.
